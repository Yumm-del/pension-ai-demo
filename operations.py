...
def candidate_body(customer, channel):
    """按已知成因生成服务候选稿。
    写作原则：先讲清制度的三项税优安排（事实陈述，不是收益承诺），再如实说明领取限制。
    不展示未经核实的节税金额——具体金额由税优计算器按客户实际输入测算。"""
    dtype = classify(customer)[0]
    bodies = {
        TYPES[0]: "个人养老金有三项税优安排：缴存可在税前扣除、投资收益暂不征税、"
                  "领取时按 3% 单独计税。您可以先了解规则，有疑问时由客户经理解释。",
        TYPES[1]: "已记录您对资金锁定的顾虑。个人养老金账户封闭运行，"
                  "达到领取基本养老金年龄等法定情形方可领取；缴存金额由您自主决定。"
                  "如需了解，我可以为您说明具体领取条件。",
        TYPES[2]: "已记录您当前的资金安排。个人养老金支持按月、分次或一次性缴存，"
                  "无最低缴存门槛，可结合您的实际情况自主决定是否参与。",
